...
@section('content')
    ...
    <ul class="nav nav-tabs" id="myTab">
        ...
        <li><a href="#4" data-toggle="tab"><span class="glyphicon glyphicon-th-large"></span>Reasons for not Complying
            </a></li>

        <li><a href="#5" data-toggle="tab"><span class="glyphicon glyphicon-th-large"></span>Attachment</a>
        </li>
    </ul>
