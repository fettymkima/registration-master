...
@section('content')
    ...
    <ul class="nav nav-tabs" id="myTab">
        ...
        <li><a href="#7" data-toggle="tab"><span class="glyphicon glyphicon-th-large"></span>Bussiness</a></li>
        <li><a href="#8" data-toggle="tab"><span class="glyphicon glyphicon-th-large"></span>Reasons</a></li>
        <li><a href="#9" data-toggle="tab"><span class="glyphicon glyphicon-th-large"></span>Attach</a></li>
    ...
    <div class="tab-content" style="  border-left: 1px solid #ddd;
        ...
        <div class="tab-pane" id="9" style="background-color: white;">
