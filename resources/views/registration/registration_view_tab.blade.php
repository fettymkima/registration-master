...
@section('content')
    ...
    <ul class="nav nav-tabs" id="myTab">
        <li class="active">
            <a  href="#1" data-toggle="tab"><span class="glyphicon glyphicon-eye-open"></span>Scheme</a>
        </li>
        <li><a href="#2" data-toggle="tab"><span class="glyphicon glyphicon-eye-open"></span>Administrator</a>
        </li>
        <li><a href="#3" data-toggle="tab"><span class="glyphicon glyphicon-eye-open"></span>Manager</a>
        </li>
        <li><a href="#4" data-toggle="tab"><span class="glyphicon glyphicon-eye-open"></span>Custodian</a>
        </li>

        <li><a href="#5" data-toggle="tab"><span class="glyphicon glyphicon-eye-open"></span>Chf</a>
        </li>
    </ul>
