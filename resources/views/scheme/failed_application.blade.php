...
@section('content')
    ...
    <ul class="nav nav-tabs" id="myTab">
        <li class="active">
            <a  href="#1" data-toggle="tab"><span class="glyphicon glyphicon-th-large"></span>General Details</a>
        </li>
        <li><a href="#2" data-toggle="tab"><span class="glyphicon glyphicon-th-large"></span>Employer(s) Particulars
            </a>
        </li>
        <li><a href="#3" data-toggle="tab"><span class="glyphicon glyphicon-th-large"></span>Board of Trustee</a>
        </li>
        <li><a href="#4" data-toggle="tab"><span class="glyphicon glyphicon-th-large"></span>Auditor and Legal Advisor</a>
        </li>
        <li><a href="#5" data-toggle="tab"><span class="glyphicon glyphicon-th-large"></span>Reasons</a>
        </li>
        <li><a href="#6" data-toggle="tab"><span class="glyphicon glyphicon-th-large"></span>Attachements & Aggrements
            </a>
        </li>
    </ul>
